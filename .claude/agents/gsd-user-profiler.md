...
<reference>
@/home/ubuntu/repos/lucienbot/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/home/ubuntu/repos/lucienbot/.claude/get-shit-done/references/user-profiling.md` to load:
