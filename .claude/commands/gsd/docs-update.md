...
<execution_context>
@/home/ubuntu/repos/lucienbot/.claude/get-shit-done/workflows/docs-update.md
</execution_context>
...
<process>
Execute the docs-update workflow from @/home/ubuntu/repos/lucienbot/.claude/get-shit-done/workflows/docs-update.md end-to-end.
