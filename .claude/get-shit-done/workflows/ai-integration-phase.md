...
```markdown
Read /home/ubuntu/repos/lucienbot/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/home/ubuntu/repos/lucienbot/.claude/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /home/ubuntu/repos/lucienbot/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /home/ubuntu/repos/lucienbot/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /home/ubuntu/repos/lucienbot/.claude/agents/gsd-eval-planner.md for instructions.
