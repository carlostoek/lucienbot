...
```bash
INIT=$(node "/home/ubuntu/repos/lucienbot/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/home/ubuntu/repos/lucienbot/.claude/get-shit-done/templates/spec.md.
