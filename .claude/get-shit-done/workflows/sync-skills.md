...
INSTALL_JS_GLOBAL="/home/ubuntu/repos/lucienbot/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /home/ubuntu/repos/lucienbot/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
