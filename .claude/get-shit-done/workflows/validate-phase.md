...
```
Task(
  prompt="Read /home/ubuntu/repos/lucienbot/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/ubuntu/repos/lucienbot/.claude/get-shit-done/templates/VALIDATION.md`
